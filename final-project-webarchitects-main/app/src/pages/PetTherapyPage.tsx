...
const PetTherapyPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <Box sx={{ width: "150%", height: "100vh", marginTop: "100px", paddingBottom: "70px" }}>
        <Typography
          variant="h4"
          gutterBottom
          sx={{
        ...
        {error ? (
          ...
          >
            ...
            <img
              src="https://i.pinimg.com/originals/fe/16/40/fe1640a16b3315ab3d8d003197f69e27.gif"
              alt="Location Access Denied"
